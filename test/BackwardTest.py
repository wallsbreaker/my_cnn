...
if __name__ == '__main__':
    ...
    cnn.add_conv_layer(10, 7, 7)
    cnn.add_pooling_layer(2, 2)
    cnn.add_conv_layer(15, 4, 4)
    cnn.add_pooling_layer(2, 2)
    cnn.add_conv_layer(20, 4, 4)
    cnn.add_pooling_layer(2, 2)
    cnn.add_conv_layer(40, 3, 3)
    cnn.add_full_connected_layer(80)
    cnn.add_full_connected_layer(9)
